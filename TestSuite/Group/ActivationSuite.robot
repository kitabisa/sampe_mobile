...
C3695 User Login with Phone 2 Times Invalid Password
    [Tags]      login       regression      negative
    [Documentation]     ${3695}
    Login with 2 Times Invalid Password                         ${phoneLogin}
...
C3691 User Login with Email 2 Times Invalid Password
    [Tags]      login       regression      negative
    [Documentation]     ${3691}
    Login with 2 Times Invalid Password                         ${activationEmail}
